(function() {
    ...
    function applyTheme(theme) {
        ...
        var svgCode = encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100" height="100">
<path fill="${color}" d="M30,50 A20,20 0 1,1 70,50 A10,10 0 1,0 30,50">
